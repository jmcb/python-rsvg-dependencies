...
def main ():
    ...
    licenses = ["LICENSE-LGPL.TXT", "LICENSE-CAIRO.TXT",
    "LICENSE-FONTCONFIG.TXT", "LICENSE-LIBPNG.TXT", "LICENSE-ZLIB.TXT",
    "LICENSE-LXML2.TXT", "LICENSE-GPL.TXT", "LICENSE-LGPLV2.1.TXT"]

    setup (
        name = "rsvg-dependencies",
        version = "0.1",
        maintainer = "Jonathan McManus",
        maintainer_email = "jonathan@acss.net.au",
        author = "various",
        url = "http://www.github.com/jmcb/python-rsvg-dependencies",
        download_url = "http://www.wxwhatever.com/jmcb/rsvg",
    ...
    Please see README.rst for more details.""",
        data_files = [(".", dlls + licenses + ["README.rst", "LICENSE.rst"])],
        classifiers = [
